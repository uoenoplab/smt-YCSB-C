...
const string CoreWorkload::FIELD_COUNT_DEFAULT = getenv("FIELD_COUNT");
...
const string CoreWorkload::FIELD_LENGTH_DEFAULT = getenv("FIELD_LENGTH");
...
ycsbc::Generator<uint64_t> *CoreWorkload::GetFieldLenGenerator(
  ...
  std::cout << "field length: " << FIELD_LENGTH_DEFAULT << " field count: " << FIELD_COUNT_DEFAULT << std::endl;
